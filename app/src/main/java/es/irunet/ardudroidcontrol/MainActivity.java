...
/*
 * ARDUDROIDCONTROL
 * Develop by Juan Jos� Garc�a
 * Rev. 2.00
 * 15-09-2014
 * 
 * Ajustado para la versi�n 2 de Kernel.
 */
...
public class MainActivity extends Activity {
	...
	protected void onResume() {
		...
		// Registrar el receptor de los datos del servicio
		IntentFilter filter = new IntentFilter();
		filter.addAction(IntentServiceLecturaDatos.ACTION_DATO_READY);
		filter.addAction(IntentServiceLecturaDatos.ACTION_END);
		filter.addAction(IntentServiceLecturaDatos.ACTION_READ_DATA);
	...
	public void disconnectFromBoard(View v) {
		...
		stopService(new Intent(getBaseContext(),
				IntentServiceLecturaDatos.class));
	...
	private void handleConnected() {
		try {
			...
			Intent msgIntent = new Intent(MainActivity.this,
					IntentServiceLecturaDatos.class);
			msgIntent.putExtra(IntentServiceLecturaDatos.EXTRA_PARAM1, "xxx");
	...
	*/
	...
	public void OnClickLecturaAnalogica(View view) {
		Intent msgIntent = new Intent(MainActivity.this,IntentServiceLecturaDatos.class);
		msgIntent.setAction(IntentServiceLecturaDatos.ACTION_READ_DATA);
		msgIntent.putExtra(IntentServiceLecturaDatos.EXTRA_PARAM1, "*|13|#");
		startService(msgIntent);
	...
	*/
    ...
    // Receptor de los datos suministrados por el servicio
	private  BroadcastReceiver intentReceiver = new BroadcastReceiver() {

		@Override
		public void onReceive(Context context, Intent intent) {
			if (intent.getAction().equals(
					IntentServiceLecturaDatos.ACTION_DATO_READY)) {
				String rta = intent.getStringExtra("DATO");
				txGetdata.setText(rta);
				// Log.d("DATO",rta);

			} else if (intent.getAction().equals(
					IntentServiceLecturaDatos.ACTION_END)) {
			...
			public void run() {
				try {
					...
					Intent msgIntent = new Intent(MainActivity.this,
							IntentServiceLecturaDatos.class);
					msgIntent
							.setAction(IntentServiceLecturaDatos.ACTION_READ_DATA);
					msgIntent.putExtra(IntentServiceLecturaDatos.EXTRA_PARAM1,
